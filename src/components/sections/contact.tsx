              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    {process.env.NEXT_PUBLIC_PHONE && <p className="text-foreground">{process.env.NEXT_PUBLIC_PHONE}</p>}
                  </div>
                </div>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    id="name"
                    {...register('name')}
                    className="w-full px-4 py-3 bg-glass-white border border-glass-border rounded-md focus:outline-none focus:ring-2 focus:ring-primary-accent focus:border-transparent text-foreground"
                  />
                ...
                <div>
                  ...
                  <textarea
                    ...
                    {...register('message')}
                    rows={5}
                    className="w-full px-4 py-3 bg-glass-white border border-glass-border rounded-md focus:outline-none focus:ring-2 focus:ring-primary-accent focus:border-transparent text-foreground resize-none"
                  ></textarea>
