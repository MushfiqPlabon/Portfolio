        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <div className="md:col-span-1 flex justify-center">
              <div className="bg-glass-white backdrop-blur-lg border border-glass-border rounded-2xl p-1 w-64 h-64 flex items-center justify-center">
                <Image
            ...
            <div className="md:col-span-2">
              ...
              <p className="text-gray-300 mb-6">{portfolioData.personalInfo.objective}</p>
              <div className="flex flex-wrap gap-4">
                <div className="bg-glass-white backdrop-blur-sm border border-glass-border rounded-lg p-4">
                  <p className="text-gray-400 text-sm">Location</p>
                  <p className="text-white">{portfolioData.personalInfo.location}</p>
                </div>
                <div className="bg-glass-white backdrop-blur-sm border border-glass-border rounded-lg p-4">
                  <p className="text-gray-400 text-sm">Email</p>
                  <p className="text-white">{portfolioData.personalInfo.links.email}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-glass-white backdrop-blur-sm border border-glass-border rounded-xl p-6">
